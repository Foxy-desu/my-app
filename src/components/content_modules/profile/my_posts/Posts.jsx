...
const Posts = (props) => {
    ...
    let createdPostsComponents = props.postData.map((post) => {
        ...
        <section className={classes.posts}>
            ...
            <div className={classes['post-form']}>
                <form name='create-post' id='post-form'>
                    <div><textarea value = {props.newPostText} onChange={textareaChange} onKeyDown={keyDownHandler} ref={textArea} className={classes['post-form__post-textfield']} type='text'></textarea></div>
